      ...
      <div className="kitchen-container py-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><span className="hover:text-primary cursor-pointer">Recipe Suggestions</span></li>
              <li><span className="hover:text-primary cursor-pointer">Ingredient Management</span></li>
              <li><span className="hover:text-primary cursor-pointer">Expiry Notifications</span></li>
              <li><span className="hover:text-primary cursor-pointer">Cost Estimation</span></li>
            </ul>
          </div>
        ...
        <div className="border-t mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} KitchenAI Assistant. All rights reserved.
          </p>
